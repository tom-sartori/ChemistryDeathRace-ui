...
export const spaceWidth: number = 50;
export const spaceHeight: number = 50;
export const spaceMargin: number = 10;
// export const boardWidth: number = spaceWidth * boardCols;
// export const boardHeight: number = spaceHeight * boardRows;
export const spaceColors: GradientColor[] = [pink, green, orange, blue, yellow, brown];
