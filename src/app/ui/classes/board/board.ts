...
export class Board extends Container {
  ...
  private generateBoard(spaceSideSize: number, categories: string[]): Space[] {
    return [
      new SpaceClassic(spaceColors[6], '1', spaceSideSize, categories[6], SpaceDisplay.CORNER_LEFT), new SpaceClassic(spaceColors[0], '2', spaceSideSize, categories[0]), new SpaceClassic(spaceColors[1], '3', spaceSideSize, categories[1]), new SpaceClassic(spaceColors[2], '4', spaceSideSize, categories[2]), new SpaceChallenge(spaceColors[3], '5', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[4], '6', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[5], '7', spaceSideSize, categories[5], SpaceDisplay.CORNER_TOP_RIGHT),
