...
export class Board extends Container {
  ...
  private generateBoard(spaceSideSize: number, categories: string[]): Space[] {
    return [
      ...
      new Space(spaceColors[5], '14', spaceSideSize, SpaceDisplay.CORNER_TOP_LEFT, categories[5]), new Space(spaceColors[4], '13', spaceSideSize, undefined, categories[4]), new Space(spaceColors[3], '12', spaceSideSize, undefined, categories[3]), new Space(spaceColors[2], '11', spaceSideSize, undefined, categories[2]), new Space(spaceColors[1], '10', spaceSideSize, undefined, categories[1]), new SpacePipe('9', spaceSideSize, -3), new Space(spaceColors[0], '8', spaceSideSize, SpaceDisplay.CORNER_BOTTOM_RIGHT, categories[0]),
      new SpacePipe('15', spaceSideSize, +3, SpaceDisplay.CORNER_BOTTOM_LEFT), new Space(spaceColors[0], '16', spaceSideSize, undefined, categories[0]), new Space(spaceColors[1], '17', spaceSideSize, undefined, categories[1]), new Space(spaceColors[2], '18', spaceSideSize, undefined, categories[2]), new Space(spaceColors[3], '19', spaceSideSize, undefined, categories[3]), new Space(spaceColors[4], '20', spaceSideSize, undefined, categories[4]), new Space(spaceColors[5], '21', spaceSideSize, SpaceDisplay.CORNER_TOP_RIGHT, categories[5]),
      new Space(spaceColors[5], '28', spaceSideSize, SpaceDisplay.CORNER_TOP_LEFT, categories[5]), new Space(spaceColors[4], '27', spaceSideSize, undefined, categories[4]), new Space(spaceColors[3], '26', spaceSideSize, undefined, categories[3]), new Space(spaceColors[2], '25', spaceSideSize, undefined, categories[2]), new SpacePipe('24', spaceSideSize, -3), new Space(spaceColors[1], '23', spaceSideSize, undefined, categories[1]), new Space(spaceColors[0], '22', spaceSideSize, SpaceDisplay.CORNER_BOTTOM_RIGHT, categories[0]),
