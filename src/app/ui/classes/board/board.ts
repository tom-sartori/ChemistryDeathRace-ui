...
export class Board extends Container {
  ...
  private generateBoard(spaceSideSize: number, categories: string[]): Space[] {
    return [
      ...
      new SpaceClassic(spaceColors[7], "Arrivée", spaceSideSize, categories[6], SpaceDisplay.CORNER_LEFT, images[40]), new SpaceClassic(spaceColors[5], undefined, spaceSideSize, categories[5], undefined, images[39]), new SpaceChallenge(spaceColors[4], spaceSideSize, categories[4], undefined, images[38]), new SpaceClassic(spaceColors[3], undefined, spaceSideSize, categories[3], undefined, images[37]), new SpaceClassic(spaceColors[2], undefined, spaceSideSize, categories[2], undefined, images[36]), new SpaceClassic(spaceColors[1], undefined, spaceSideSize, categories[1], undefined, images[35]), new SpacePipe('-3', spaceSideSize, -3, SpaceDisplay.CORNER_BOTTOM_RIGHT, images[34]),
    ];
  }
