...
export class Board extends Container {
  ...
  private generateBoard(spaceSideSize: number, categories: string[]): Space[] {
    return [
      new SpaceClassic(spaceColors[6], '1', spaceSideSize, categories[6], SpaceDisplay.CORNER_LEFT), new SpaceClassic(spaceColors[0], '2', spaceSideSize, categories[0]), new SpaceClassic(spaceColors[1], '3', spaceSideSize, categories[1]), new SpaceClassic(spaceColors[2], '4', spaceSideSize, categories[2]), new SpaceClassic(spaceColors[3], '5', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[4], '6', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[5], '7', spaceSideSize, categories[5], SpaceDisplay.CORNER_TOP_RIGHT),
      new SpaceClassic(spaceColors[5], '14', spaceSideSize, categories[5], SpaceDisplay.CORNER_TOP_LEFT), new SpaceClassic(spaceColors[4], '13', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[3], '12', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[2], '11', spaceSideSize, categories[2]), new SpaceClassic(spaceColors[1], '10', spaceSideSize, categories[1]), new SpacePipe('9', spaceSideSize, -3), new SpaceClassic(spaceColors[0], '8', spaceSideSize, categories[0], SpaceDisplay.CORNER_BOTTOM_RIGHT),
      new SpacePipe('15', spaceSideSize, +3, SpaceDisplay.CORNER_BOTTOM_LEFT), new SpaceClassic(spaceColors[0], '16', spaceSideSize, categories[0]), new SpaceClassic(spaceColors[1], '17', spaceSideSize, categories[1]), new SpaceClassic(spaceColors[2], '18', spaceSideSize, categories[2]), new SpaceClassic(spaceColors[3], '19', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[4], '20', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[5], '21', spaceSideSize, categories[5], SpaceDisplay.CORNER_TOP_RIGHT),
      new SpaceClassic(spaceColors[5], '28', spaceSideSize, categories[5], SpaceDisplay.CORNER_TOP_LEFT), new SpaceClassic(spaceColors[4], '27', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[3], '26', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[2], '25', spaceSideSize, categories[2]), new SpacePipe('24', spaceSideSize, -3), new SpaceClassic(spaceColors[1], '23', spaceSideSize, categories[1]), new SpaceClassic(spaceColors[0], '22', spaceSideSize, categories[0], SpaceDisplay.CORNER_BOTTOM_RIGHT),
      new SpaceClassic(spaceColors[0], '29', spaceSideSize, categories[0], SpaceDisplay.CORNER_BOTTOM_LEFT), new SpaceClassic(spaceColors[1], '30', spaceSideSize, categories[1]), new SpaceClassic(spaceColors[2], '31', spaceSideSize, categories[2]), new SpaceClassic(spaceColors[3], '32', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[4], '33', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[5], '34', spaceSideSize, categories[5]), new SpaceClassic(spaceColors[0], '35', spaceSideSize, categories[0], SpaceDisplay.CORNER_TOP_RIGHT),
      new SpaceClassic(spaceColors[6], '42', spaceSideSize, categories[6], SpaceDisplay.CORNER_LEFT), new SpaceClassic(spaceColors[5], '41', spaceSideSize, categories[5]), new SpaceClassic(spaceColors[4], '40', spaceSideSize, categories[4]), new SpaceClassic(spaceColors[3], '39', spaceSideSize, categories[3]), new SpaceClassic(spaceColors[2], '38', spaceSideSize, categories[2]), new SpaceClassic(spaceColors[1], '37', spaceSideSize, categories[1]), new SpacePipe('36', spaceSideSize, +3, SpaceDisplay.CORNER_BOTTOM_RIGHT),
    ];
  }
