...
import Container = zim.Container;
import Stage = zim.Stage;
import Point = zim.Point;
import Boundary = zim.Boundary;
import Bind = zim.Bind;
import Shape = zim.Shape;
import Physics = zim.Physics;
import GradientColor = zim.GradientColor;
import RadialColor = zim.RadialColor;
import BitmapColor = zim.BitmapColor;
